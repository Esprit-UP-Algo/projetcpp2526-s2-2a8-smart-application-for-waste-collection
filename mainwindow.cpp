...
{
    // Récupère la ligne sélectionnée dans le QTableWidget
    ...
    // Récupère l'ID (colonne 0 — cachée)
    ...
    // Charge le recyclage depuis la base de données
