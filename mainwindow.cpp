...
{
    QStringList headers = {
        "🆔 ID", "👤 Nom", "👤 Prénom", "🪪 CIN", "🏢 Type",
        "📍 Zone", "📞 Téléphone", "📌 Statut", "🏠 Adresse", "👷 CIN Employé"
    };
    ...
    // ── Même style que afficherEmployes() ────────────────────────
    ...
    for (const Client &c : liste) {
        ...
        QStringList vals = {
            QString::number(c.idClient()),
            c.nom(), c.prenom(), c.cin(),
            c.typeClient(), c.zone(), c.telephone(),
            c.statutCompte(), c.adresseComplete(), c.cinEmploye()
        };
        ...
        ui->tableWidget_client->setColumnHidden(9, true); // cacher CIN_Employé
...
void MainWindow::on_boutonAnciennete_clicked()
{
    Calcule_anciennete ca;
    ca.calculerAncienneteEtPrime(this);
}
// ================================================================
...
void MainWindow::afficherWidgetAjoutRecyclage()
{
    ...
    QString editStyle =
        ...
        "QComboBox:hover { border:1px solid #2C5F7C; }"
        "QDoubleSpinBox { background-color:#F9FAFB; border:1px solid #D1D5DB; border-radius:8px; padding:12px 16px; font-size:14px; color:#111827; }"
        "QDoubleSpinBox:hover { border:1px solid #2C5F7C; }"
        "QDateEdit { background-color:#F9FAFB; border:1px solid #D1D5DB; border-radius:8px; padding:12px 16px; font-size:14px; color:#111827; }"
        "QDateEdit:hover { border:1px solid #2C5F7C; }";
...
void MainWindow::afficherWidgetModifierCollecte(int idCollecte)
{
    ...
    QString labelStyle = "QLabel { background-color:transparent; padding:5px; font-size:13px; font-weight:600; color:#374151; }";
    QString editStyle =
        "QLineEdit { background-color:#F9FAFB; border:1px solid #D1D5DB; border-radius:8px; padding:12px 16px; font-size:14px; color:#111827; } QLineEdit:hover { border:1px solid #1A7A4A; }"
        "QComboBox { background-color:#F9FAFB; border:1px solid #D1D5DB; border-radius:8px; padding:12px 16px; font-size:14px; color:#111827; } QComboBox:hover { border:1px solid #1A7A4A; }"
        "QDoubleSpinBox { background-color:#F9FAFB; border:1px solid #D1D5DB; border-radius:8px; padding:12px 16px; font-size:14px; color:#111827; } QDoubleSpinBox:hover { border:1px solid #1A7A4A; }"
        "QDateEdit { background-color:#F9FAFB; border:1px solid #D1D5DB; border-radius:8px; padding:12px 16px; font-size:14px; color:#111827; } QDateEdit:hover { border:1px solid #1A7A4A; }";
